        ...
        return (
            <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column" }}>
                    <label style={{ fontSize: "1.15rem"}}>Support amount</label>
                ...
                <div>
                    <h3 style={{ marginBottom: "1rem"}}>Total Supports: {totalCoffees?.toString()}</h3>
                    <p style={{ fontSize: "1.15rem" }}>Recent Supports:</p>
